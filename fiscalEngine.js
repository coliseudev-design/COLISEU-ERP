...
export const SEFAZ_SERVIDORES = {
  MS: {
    HOMOLOGACAO: {
      ...
      consultaChave: 'https://homologacao.nfe.ms.gov.br/ws/NFeConsultaProtocolo4',
    ...
    PRODUCAO: {
      statusServico: 'https://nfe.ms.gov.br/ws/NFeStatusServico4',
      autorizacao: 'https://nfe.ms.gov.br/ws/NFeAutorizacao4',
      retAutorizacao: 'https://nfe.ms.gov.br/ws/NFeRetAutorizacao4',
      consultaChave: 'https://nfe.ms.gov.br/ws/NFeConsultaProtocolo4',
      inutilizacao: 'https://nfe.ms.gov.br/ws/NFeInutilizacao4',
      recepcaoEvento: 'https://nfe.ms.gov.br/ws/NFeRecepcaoEvento4',
    },
  },
  SVRS: {
    HOMOLOGACAO: {
